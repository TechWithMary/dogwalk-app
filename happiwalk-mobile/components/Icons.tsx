...
export function Power({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function ArrowLeft({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
...
export function Phone({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function Navigation({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function DogIcon({ size = 24, color = '#052e05' }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <Path d="M11.25 16.25h1.5L12 17z" />
      <Path d="M16 14v.5" />
...
export function Send({ size = 24, color = '#000000' }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function DollarSign({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function CheckCircle({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function AlertCircle({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function PlusCircle({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function LogOut({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function HelpCircle({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function Search({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function MessageCircle({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function ChevronDown({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function Shield({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function Settings({ size = 24, color = '#000000', strokeWidth = 2 }) {
  return (
    <Svg
      width={size}
      height={size}
...
export function Hourglass({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
      <Path d="M5 22h14" />
      <Path d="M5 2h14" />
...
export function Timer({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function Footprints({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
      <Path d="M4 16v-2.5a3 3 0 1 1 6 0V16" />
      <Path d="M4 14h6" />
      <Path d="M14 21v-2.5a3 3 0 1 1 6 0V21" />
      <Path d="M14 19h6" />
      <Path d="M16 13a3 3 0 0 1 2.24-2.913" />
      <Path d="M9 7a3 3 0 0 1 5.197-.586" />
    </Svg>
  );
}

export function PawPrint({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function Cash({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function Heart({ size = 24, color = '#000000', fill = 'none', strokeWidth = 2 }: { size?: number; color?: string; fill?: string; strokeWidth?: number }) {
  return (
...
export function Whatsapp({ size = 24, color = '#000000' }: { size?: number; color?: string }) {
  return (
...
export function Copy({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function Crosshair({ size = 24, color = '#000000', strokeWidth = 2 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
      <Circle cx="12" cy="12" r="10" />
