...
const styles = StyleSheet.create({
  ...
  bankSubTypeBtn: { flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: '#374151', borderWidth: 2, borderColor: 'transparent', alignItems: 'center' },
  bankSubTypeBtnActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
