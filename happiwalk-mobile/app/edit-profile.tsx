...
const styles = StyleSheet.create({
  ...
  bankSubTypeBtn: { flex: 1, paddingVertical: 12, borderRadius: 12, backgroundColor: 'transparent', borderWidth: 2, borderColor: '#374151', alignItems: 'center' },
  bankSubTypeBtnActive: { borderColor: '#13ec13' },
  bankSubTypeText: { fontSize: 11, fontWeight: '800', color: '#9CA3AF' },
  bankSubTypeTextActive: { color: '#13ec13' },
  bankGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  bankChip: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: 'transparent', borderWidth: 2, borderColor: '#374151' },
  bankChipActive: { borderColor: '#13ec13' },
