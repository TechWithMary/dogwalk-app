...
const styles = StyleSheet.create({
  ...
  optionChipActive: { backgroundColor: 'transparent', borderColor: '#13ec13' },
  ...
  bankChipActive: { backgroundColor: 'transparent', borderColor: '#13ec13' },
  ...
  typeBtnActive: { backgroundColor: 'transparent', borderColor: '#13ec13' },
