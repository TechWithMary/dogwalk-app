        ...
        {step === 7 && (
          <View style={styles.stepContainer}>
            <View style={styles.successBox}>
              ...
              <Text style={styles.thanksText}>Gracias por unirte a Happiwalk 💚</Text>
            </View>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  docCardDone: { borderColor: '#13ec13' },
  ...
  optionChipActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
  ...
  bankChipActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
  ...
  optionChipBigActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
  ...
  typeBtnActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
  ...
  subTypeBtnActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
  ...
  radiusBtnActive: { backgroundColor: '#4B5563', borderColor: '#13ec13' },
  ...
  dayBtn: { paddingHorizontal: 14, paddingVertical: 12, borderRadius: 12, backgroundColor: '#374151', borderWidth: 2, borderColor: 'transparent' },
  ...
  successTitle: { fontSize: 28, fontWeight: '900', color: '#FFFFFF', marginBottom: 12, marginTop: 24 },
  successText: { fontSize: 14, color: '#9CA3AF', textAlign: 'center', marginBottom: 40, lineHeight: 22 },
  timeline: { alignSelf: 'stretch', gap: 16, marginBottom: 40 },
  ...
  thanksText: { fontSize: 12, color: '#6B7280', textAlign: 'center', marginTop: 48 },
