...
export const OWNER_PATTERNS = [
  ...
  {
    keywords: ['eliminar cuenta', 'borrar cuenta'],
    response: 'Para eliminar tu cuenta, escribinos por WhatsApp. Procesamos la solicitud en pocos días hábiles.',
  },
  {
...
export const WALKER_QUICK_REPLIES = [
  ...
  { label: 'Más paseos', message: '¿Cómo consigo más paseos?' },
  { label: 'Hablar con humano', message: 'Quiero hablar con una persona' },
];
