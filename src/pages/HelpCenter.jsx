  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        ...
        <h3 className="text-lg font-extrabold text-gray-900 mb-3 px-1">¿Necesitas más ayuda?</h3>

        <div className="space-y-3">
          <button
            onClick={() => setShowChat(true)}
            className="w-full bg-white rounded-2xl border border-gray-100 p-4 flex items-center text-left"
          >
            <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
              <MessageCircle className="w-6 h-6 text-sky-500" />
            </div>
            <div className="ml-4 flex-1">
              <p className="font-bold text-sm text-gray-900">Chat con Asistente</p>
              <p className="text-xs text-gray-500 mt-0.5">
                {isWalker ? 'Paseos, GPS, ganancias' : 'Reservas, pagos, mascotas'}
              </p>
            </div>
          ...
          <button
            ...
            className="w-full bg-white rounded-2xl border-2 border-emerald-500 p-4 flex items-center text-left"
          >
            <div className="w-12 h-12 bg-emerald-500 rounded-full flex items-center justify-center">
            ...
            <div className="ml-4 flex-1">
              <p className="font-bold text-sm text-gray-900">WhatsApp Soporte</p>
              <p className="text-xs text-gray-500 mt-0.5">{WHATSAPP_DISPLAY} · Lun-Sáb 7am-9pm</p>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-400" />
          </button>
        </div>
